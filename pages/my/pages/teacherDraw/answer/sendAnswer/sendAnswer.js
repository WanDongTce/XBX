...
Page({
  ...
  onLoad: function (options) {
      console.log(options);
      id = options.id;
      console.log(options.allStroker)
      console.log(typeof(options.allStroker))
  ...
  send: function(){
    ...
    //   console.log(that.data.val)
      ...
      network.POST({
          url: 'v14/home-work-custom/answer-add',
          params: {
              ...
              'an_type': 2,
              'video_json': JSON.stringify(jsonall)
            //   'video_json': jsonall
          },
          success: function (res) {
              ...
              if (res.data.code == 200) {
                  ...
                  wx.navigateTo({
                      url: '/pages/my/pages/teacherDrawList/teacherDrawList'
                  });
              } else {
                  wx.showToast({
