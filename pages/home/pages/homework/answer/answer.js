            ...
            self.getCoverImg(function () {
                if (recorderManager) {
                    ...
                    recorderManager.onStop((res) => {
                        ...
                        wx.navigateTo({
                            url: '/pages/home/pages/homework/answer/bofang/bofang?allStroker=' + model + "&temptime=" + temptime + "&mp3=" + res.tempFilePath + '&coverImg=' + self.data.coverImg + '&flag=1&bgImg=' + self.data.bgImg + "&id=" + id
                        });
                    ...
                    wx.navigateTo({
                        url: '/pages/home/pages/homework/answer/bofang/bofang?allStroker=' + model + "&temptime=" + temptime + '&coverImg=' + self.data.coverImg + '&flag=1&bgImg=' + self.data.bgImg + "&id=" + id
                    });
