...
Page({
    ...
    tz_write: function (e) {
      wx.navigateTo({        
        url: '/pages/home/pages/courseList/write/write?mytag=' + e.currentTarget.dataset.mytag + '&courseid=' + courseid + '&parent=' + e.currentTarget.dataset.parent,
      })
    },
    // 简介中收藏
    collect:function(e){
    ...
    onShareAppMessage() {
      ...
      return {
        ...
        path: '/pages/home/pages/courseList/courseDetail/courseDetail?courseid=' + courseid + '&videopic=' + that.data.videopic,
